...
<html lang="es">
    ...
    <form id="datos" class="col-lg-5">
            ...
            <label for="dni"> DNI:</label> <input type="number" id="dni" value="" name="dni" required class="form-control"/>
            <label for="nombre">Nombre:</label><input type="text" id="nombre" value="" name="nombre" required class="form-control"/>
            <label for="apellido">Apellido:</label><input type="text" id="apellido" value="" name="apellido" required class="form-control"/>
            <label for="mail">Email:</label> <input type="email" name="mail" id="mail" value="" required class="form-control"/>
            <label for="celular">Celular:</label> <input type="text" id="celular" value="" name="celular" required class="form-control"/>
