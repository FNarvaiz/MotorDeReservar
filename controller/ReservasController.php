...
class ReservasController extends ControladorBase{
    ...
    public function Descuento($promocion,$diferencia,$ImporteEstadia){
        ...
        $descuentoRealizado=$ImporteEstadia*$promocion->Descuento/100;
    ...
    public function EnvioDeMail($subject, $message,$emailCliente){
        $para="Mail@dominio.com,".$emailCliente;
        $email_from = 'Motor de reservas<reservas@dominio.com>';
        $headers  = 'MIME-Version: 1.0' . "\r\n";
        $headers .= 'Content-type: text/html; charset=UTF-8' . "\r\n";
        $headers .= "From: reservas@dominio.com\r\n";
 ...
 <tr><td>&nbsp;</td>  <td></td> </tr> <tr>
  ...
  <p><font face='Arial, Helvetica, sans-serif' color='#1b232a' style='font-size:18px;'>Sistema CostaReservas</font><br /><font face='Arial, Helvetica, sans-serif' color='#a6acaf' ><em  style='font-size:12px;'>Empresa</em></font><br />    <font face='Arial, Helvetica, sans-serif' style='font-size:12px'><strong><font color='#37424a'>(02291) 43-1766</font></strong> ·  <a href='mailto:".$mail. "'>".$mail."</a> </font><br />   </p>
   <p><font face='Arial, Helvetica, sans-serif' color='#1b232a'  style='font-size:14px;'>Marcamos y hacemos la diferencia</font><br /><font face='Arial, Helvetica, sans-serif' color='#37424a' size='-1'> <a href='http://www.dominio.com'>www.dominio.com</a></font></p></td></tr></table>";
        }
